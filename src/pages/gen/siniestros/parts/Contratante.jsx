        ...
        return (
            <div className="col-lg-3">
                <table className="text-left fs12">
                    ...
                    <tr>
                        <td className="form-label fw-bold text-secondary fs-7" colSpan={2}>Incapacidad:</td>
                    </tr>
                    <tr>
                        <td colSpan={2}>{siniestro.nmIncapacidad}</td>
                    </tr>
                    <tr>
                        <td className="form-label fw-bold text-secondary fs-7" colSpan={2}>Fc.Recepción:</td>
                    </tr>
                    <tr>
                        <td colSpan={2}> {siniestro.fcSiniestro ? moment(siniestro.fcSiniestro).locale('moment/locale/es').local().format("DD/MMM/YYYY") : null}</td>
                    </tr>
                    <tr>
                        <td className="form-label fw-bold text-secondary fs-7" colSpan={2}>Titular:</td>
                    </tr>
                    <tr>
                        <td colSpan={2}>{siniestro.titular}</td>
                    </tr>
                    <tr>
                        <td className="form-label fw-bold text-secondary fs-7" colSpan={2}>Reclamante:</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td className="form-label fw-bold text-secondary fs-7" colSpan={2}>Tipo Sin:</td>
                    </tr>
                    <tr>

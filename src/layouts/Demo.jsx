...
export const DemoLogin = () => {
  return (
    <>
      <div
        className="bg-fullscreen bg-texture bg-img-center"
      ...
      >
        <div className="login-filter-glass border border-success rounded-5 d-flex align-items-center py-4 py-xl-5 px-2 px-xl-4">
                  ...
                  <div className="h-100 d-flex justify-content-between flex-xl-column py-2 px-xxl-2">
                    <div className="me-4 me-xl-0">
                      <div className="text-white d-none d-xl-block mb-3">
                        ...
                        <p className="fs-4 my-0 lh-sm fw-bold text-success">
                          novedades
                        </p>
                      </div>
                    ...
                    <div className="d-flex gap-2 gap-md-3 text-white">
                      <HomeOption
                        icon="uqai-polizas-asegurados"
                        text="Polizas asegurados"
                        to="/"
                      />
                      <HomeOption
                ...
                <main className="h-100 row flex-column flex-xl-row g-0">
                  <div className="col-xl-6 col-xxl-5 align-self-center">
                    <div className="flex text-white px-4 px-md-5 py-xxl-3 px-xxl-4 ms-xxl-5">
                      <h1 className="display-2 fw-normal mt-4 mt-xl-0 mb-3 mb-xl-5">
                        Bienbenido
                      </h1>
                      <h2 className="fw-bold m-0">
                        Este es tu sistema para realizar tus{" "}
    ...
    <>
            ...
            <div className="row">
              <div className="col-xl-4 py-2">
                <Card className="shadow">
                  ...
                  <CardBody>
                    <div className="d-flex flex-wrap gap-2 mb-3 justify-content-between align-items-baseline">
                      ...
                      <button type="button" className="btn btn-alternative">
                        Alternative
                      </button>
                  ...
                  <CardBody>
                    <div className="d-flex flex-wrap justify-content-between gap-2">
                      ...
                      <div className="text-center">
                        ...
                        <p className="js-classname">
                          uqai-polizas-contratantes
                        </p>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <p className="js-classname">
                          uqai-lista-siniestros-reportados
                        </p>
                      </div>
      ...
      <Modal isOpen={isOpenModal1} toggle={toggleModal1} centered>
        ...
        <ModalBody>
          <div className="d-flex flex-column">
            ...
            <h4 className="text-secondary text-center mb-3 fw-bold">
              Modal de confirmacion
            </h4>
            <p className="m-0 text-center">
              asdasdasdasdasasdasdasdasdasasd awdsdasdasdsd
            </p>
          </div>
        </ModalBody>
      ...
      <Modal isOpen={isOpenModal2} toggle={toggleModal2} size="xl" centered>
        ...
        <ModalBody>
          ...
          consequuntur iste natus quam saepe, sint? Architecto consequuntur,
          dolore dolores esse, ipsa libero mollitia neque porro quisquam

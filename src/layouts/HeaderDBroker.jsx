  ...
  return (
    <Dropdown isOpen={isOpen} toggle={toggle}>
      <DropdownToggle data-toggle="dropdown" tag="div">
        <div className="d-flex py-1 px-2" role="button" aria-label="avatar">
          <div className="d-flex flex-column justify-content-center">
            ...
            <span className="text-success fw-bold text-end lh-1">
              {lastName}
            </span>
          </div>
      ...
      <DropdownMenu
        ...
        className="px-2 py-3 bg-primary bg-gradient border-0 shadow"
      >
